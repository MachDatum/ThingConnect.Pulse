...
import { Box, Flex, Stack, Text, IconButton, Portal, Tooltip, Badge } from '@chakra-ui/react';
...
export const SidebarBody = React.forwardRef<HTMLDivElement, SidebarBodyProps>(
  function SidebarBody(props, ref) {
    ...
    return (
      <Box ref={ref} flex='1' overflowY='auto' py='2' {...rest}>
        {children}
      </Box>
    );
  }
...
export const SidebarFooter = React.forwardRef<HTMLDivElement, SidebarFooterProps>(
  function SidebarFooter(props, ref) {
    ...
    return (
      <Box ref={ref} p='4' borderTop='1px solid' borderColor='border.subtle' {...rest}>
        {children}
      </Box>
    );
  }
...
export const SidebarGroupContent = React.forwardRef<HTMLDivElement, SidebarGroupContentProps>(
  function SidebarGroupContent(props, ref) {
    ...
    return (
      <Box ref={ref} pl={expanded ? '6' : '0'} py='1' overflow='hidden' {...rest}>
        <Stack gap='1'>{children}</Stack>
      </Box>
    );
  }
...
export const SidebarOverlay = React.forwardRef<HTMLDivElement>(function SidebarOverlay(props, ref) {
