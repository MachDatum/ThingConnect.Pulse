        ...
        <Sidebar.Container>
          ...
          <Sidebar.Body>
            <Sidebar.Section title='Main'>
              <Sidebar.Item id='dashboard' icon={<LuHome />} active>
                Dashboard
              </Sidebar.Item>

              <Sidebar.Group id='monitoring'>
                <Sidebar.GroupTrigger groupId='monitoring' icon={<LuMonitor />} badge='12'>
                  Monitoring
            ...
            <Sidebar.Section title='Analytics'>
              <Sidebar.Group id='reports'>
                <Sidebar.GroupTrigger groupId='reports' icon={<LuBarChart3 />}>
                  Reports
                </Sidebar.GroupTrigger>
