...
export function ConfigurationDescription({
  ...
  return (
    <motion.div
      style={{ flex: isCollabsable ? 1 : 'none', minWidth: 0 }}
      animate={{ flexGrow: isCollabsable ? 1 : 0 }}
            ...
            <Accordion.Root multiple collapsible>
              ...
              <Accordion.Item value='schema'>
                ...
                <Accordion.ItemContent>
                  <Accordion.ItemBody>
                    <Text fontSize='sm'>
                      The configuration file has a <b>version</b> and <b>global defaults</b>.
                      Defaults apply to all targets unless overridden.
                    </Text>
