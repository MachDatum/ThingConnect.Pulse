...
export const SelectTrigger = function SelectTrigger({
  ref,
  ...props
}: SelectTriggerProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
...
const SelectClearTrigger = function SelectClearTrigger({
  ref,
  ...props
}: ChakraSelect.ClearTriggerProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
  return (
...
export const SelectContent = function SelectContent({
  ref,
  ...props
}: SelectContentProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
export const SelectItem = function SelectItem({
  ref,
  ...props
}: ChakraSelect.ItemProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
export const SelectValueText = function SelectValueText({
  ref,
  ...props
}: SelectValueTextProps & { ref?: React.RefObject<HTMLSpanElement | null> }) {
...
export const SelectRoot = function SelectRoot({
  ref,
  ...props
}: ChakraSelect.RootProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
  return (
...
export const SelectItemGroup = function SelectItemGroup({
  ref,
  ...props
}: SelectItemGroupProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
