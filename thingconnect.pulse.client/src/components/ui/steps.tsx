...
export const StepsItem = function StepsItem({
  ref,
  ...props
}: StepsItemProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
export const StepsIndicator = function StepsIndicator({
  ref,
  ...props
}: StepsIndicatorProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
