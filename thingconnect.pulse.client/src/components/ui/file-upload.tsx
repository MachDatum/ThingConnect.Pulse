...
export const FileUploadRoot = function FileUploadRoot({
  ref,
  ...props
}: FileUploadRootProps & { ref?: React.RefObject<HTMLInputElement | null> }) {
...
export const FileUploadDropzone = function FileUploadDropzone({
  ref,
  ...props
}: FileUploadDropzoneProps & { ref?: React.RefObject<HTMLInputElement | null> }) {
...
const FileUploadItem = function FileUploadItem({
  ref,
  ...props
}: FileUploadItemProps & { ref?: React.RefObject<HTMLLIElement | null> }) {
...
export const FileUploadList = function FileUploadList({
  ref,
  ...props
}: FileUploadListProps & { ref?: React.RefObject<HTMLUListElement | null> }) {
...
export const FileInput = function FileInput({
  ref,
  ...props
}: FileInputProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
