  ...
  return (
    <>
      ...
      >
        ...
        <Box py={20}>
          <Container maxW='5xl'>
            <VStack gap={6} textAlign='center'>
              ...
              <Text fontSize='lg' color='gray.600' _dark={{ color: 'gray.300' }} maxW='3xl'>
                One platform for limitless industrial monitoring. From network devices to production
                lines – all in one local-first solution.
              </Text>
            </VStack>
          </Container>
        </Box>
        ...
        {/* Technology Stack */}
        <Box bg='gray.50' _dark={{ bg: 'gray.900' }} py={20}>
          <Container maxW='5xl'>
            <VStack gap={6} textAlign='center'>
              <Heading size='2xl' color='gray.800' _dark={{ color: 'white' }}>
