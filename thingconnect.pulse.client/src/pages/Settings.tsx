      ...
      <Alert status="info">
        <Box>
          ...
          <Text fontSize="sm" mt={1}>
            Application settings will be implemented as needed during development.
            This will include notification preferences, display options, and system configuration.
          </Text>
        </Box>
      </Alert>
      ...
      <VStack gap={4}>
        ...
        <Box p={6} borderRadius="md" border="2px dashed" borderColor="gray.300" _dark={{ borderColor: 'gray.600' }} w="100%">
          <VStack gap={3} color="gray.500" _dark={{ color: 'gray.400' }}>
            <Palette size={32} />
            <Text textAlign="center">
              <strong>Display Preferences</strong><br />
