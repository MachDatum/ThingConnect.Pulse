      ...
      <VStack gap="500" align="stretch">
        <Box textAlign="center">
          <HStack justify="center" align="center" mb="200">
            ...
            <Heading textStyle="ui.heading.large">Welcome to Pulse</Heading>
          </HStack>
        ...
        <Box layerStyle="atlassian.card">
          ...
          <Text textStyle="ui.body.medium" color="fg.muted" mb="200">
          ...
          <Link as={RouterLink} to="/theme-showcase" color="blue.fg" textDecoration="underline">
            View Theme Showcase →
          </Link>
        </Box>

        <Box textAlign="center">
          <Button variant="plain" colorPalette="danger" onClick={handleLogout} size="sm">
            Logout
          </Button>
        </Box>
      </VStack>
