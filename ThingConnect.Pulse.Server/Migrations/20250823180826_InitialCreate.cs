    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AppliedTs = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastChangeTs = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Ts = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                EndpointId = table.Column<Guid>(type: "TEXT", nullable: false),
                BucketTs = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                EndpointId = table.Column<Guid>(type: "TEXT", nullable: false),
                BucketDate = table.Column<string>(type: "TEXT", nullable: false),
                UpPct = table.Column<double>(type: "REAL", nullable: false),
                AvgRttMs = table.Column<double>(type: "double precision", nullable: true),
                DownEvents = table.Column<int>(type: "INTEGER", nullable: false)
            },
